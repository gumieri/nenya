...
func TestClassifyClient(t *testing.T) {
	tests := []struct {
		...
		{"claude-code via ua", map[string]string{"User-Agent": "claude-code/1.0.0"}, true, "claude-code"},
		{"claude-code ua with version suffix", map[string]string{"User-Agent": "claude-code/2.3.1 node/20.0"}, true, "claude-code"},
		{"claude-code via editor-plugin-version", map[string]string{"Editor-Plugin-Version": "claude-code/1.2.3"}, true, "claude-code"},
