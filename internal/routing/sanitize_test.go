...
func TestProviderSupportsStreamOptions(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.provider, func(t *testing.T) {
			got := providerSupportsStreamOptions(tt.provider, nil)
			if got != tt.want {
...
func TestProviderSupportsAutoToolChoice(t *testing.T) {
	tests := []struct {
		provider string
		want     bool
	}{
	...
	for _, tt := range tests {
		t.Run(tt.provider, func(t *testing.T) {
			got := providerSupportsAutoToolChoice(tt.provider, nil)
			if got != tt.want {
				t.Fatalf("got %v, want %v", got, tt.want)
			}
		})
...
func TestProviderSupportsContentArrays(t *testing.T) {
	tests := []struct {
		provider string
		want     bool
	}{
	...
	for _, tt := range tests {
		t.Run(tt.provider, func(t *testing.T) {
			got := providerSupportsContentArrays(tt.provider, nil)
			if got != tt.want {
				t.Fatalf("got %v, want %v", got, tt.want)
			}
		})
