...
var ModelRegistry = map[string]ModelEntry{
	...
	"claude-opus-4-8":            {Provider: "anthropic", Format: "anthropic", MaxContext: 1000000, MaxOutput: 128000, Thinking: ModelThinkingConfig{Min: 1024, Max: 128000, ZeroAllowed: true, Levels: []string{"low", "medium", "high", "xhigh", "max"}}, Pricing: PricingOverride{InputCostPer1M: 4.29, OutputCostPer1M: 21.46}},
	"claude-fable-5":             {Provider: "anthropic", Format: "anthropic", MaxContext: 1000000, MaxOutput: 128000, Thinking: ModelThinkingConfig{Min: 1024, Max: 128000, ZeroAllowed: true, Levels: []string{"low", "medium", "high", "xhigh", "max"}}, Pricing: PricingOverride{InputCostPer1M: 10.0, OutputCostPer1M: 50.0}},
	"claude-sonnet-5":            {Provider: "anthropic", Format: "anthropic", MaxContext: 1000000, MaxOutput: 128000, Thinking: ModelThinkingConfig{Min: 1024, Max: 128000, ZeroAllowed: true, Levels: []string{"low", "medium", "high", "xhigh", "max"}}, Pricing: PricingOverride{InputCostPer1M: 2.0, OutputCostPer1M: 10.0}},
	"claude-opus-4-6":            {Provider: "anthropic", Format: "anthropic", MaxContext: 1000000, MaxOutput: 128000, Thinking: ModelThinkingConfig{Min: 1024, Max: 128000, ZeroAllowed: true, Levels: []string{"low", "medium", "high", "xhigh", "max"}}, Pricing: PricingOverride{InputCostPer1M: 5.0, OutputCostPer1M: 25.0}},
	...
	"kimi-k2.7-code":           {Provider: "moonshot", MaxContext: 262144, MaxOutput: 65536, Thinking: ModelThinkingConfig{Min: 1024, Max: 32000, ZeroAllowed: false, DynamicAllowed: true, Levels: []string{"low", "medium", "high"}}},
	...
	"gpt-5.4-nano":             {Provider: "openai", MaxContext: 400000, MaxOutput: 128000, Thinking: ModelThinkingConfig{Levels: []string{"low", "medium", "high", "xhigh"}}, Pricing: PricingOverride{InputCostPer1M: 0.18, OutputCostPer1M: 1.10}},
