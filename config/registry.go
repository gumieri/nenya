...
var ModelRegistry = map[string]ModelEntry{
	...
	"gemini-3.5-flash":               {Provider: "gemini", MaxContext: 1048576, MaxOutput: 65536, Thinking: ModelThinkingConfig{Min: 128, Max: 32768, DynamicAllowed: true, Levels: []string{"minimal", "low", "medium", "high"}}, Pricing: PricingOverride{InputCostPer1M: 0.075, OutputCostPer1M: 0.3}},
	...
	"gemini-3-pro-preview":           {Provider: "gemini", MaxContext: 1048576, MaxOutput: 65536, Thinking: ModelThinkingConfig{Min: 128, Max: 32768, DynamicAllowed: true, Levels: []string{"low", "high"}}, Pricing: PricingOverride{InputCostPer1M: 1.25, OutputCostPer1M: 12.0}},
	...
	"claude-opus-4-8":            {Provider: "anthropic", Format: "anthropic", MaxContext: 1000000, MaxOutput: 128000, Thinking: ModelThinkingConfig{Min: 1024, Max: 128000, ZeroAllowed: true, Adaptive: true, Levels: []string{"low", "medium", "high", "xhigh", "max"}}, Pricing: PricingOverride{InputCostPer1M: 4.29, OutputCostPer1M: 21.46}},
	...
	"claude-sonnet-4-6":          {Provider: "anthropic", Format: "anthropic", MaxContext: 200000, MaxOutput: 64000, Thinking: ModelThinkingConfig{Min: 1024, Max: 128000, ZeroAllowed: true, Levels: []string{"low", "medium", "high", "max"}}, Pricing: PricingOverride{InputCostPer1M: 3.0, OutputCostPer1M: 15.0}},
