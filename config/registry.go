...
var ModelRegistry = map[string]ModelEntry{
	...
	"grok-4.3":                     {Provider: "xai", MaxContext: 1000000, MaxOutput: 65536, Thinking: ModelThinkingConfig{Levels: []string{"none", "low", "medium", "high"}}, Pricing: PricingOverride{InputCostPer1M: 1.25, OutputCostPer1M: 2.5}},
